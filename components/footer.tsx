...
export default function Footer() {
  return (
    ...
    <div className="flex flex-row">
        <div className="flex flex-col gap-2 justify-center w-\[35\%\] w-\[35\%\]">
            <div className="flex items-center w-full gap-4">
                <Image height={80} width={80} alt="Logo Preview" src="https://tailwind-generator.b-cdn.net/favicon.png" />
        ...
        <div className="flex flex-row w-[65%] justify-end gap-16 text-nowrap">
            ...
            <div className="flex flex-col gap-2">
                ...
                <form className="flex items-center">
                    <input type="email" name="email" placeholder="Enter your email" className="w-full bg-gray-100 text-gray-700 rounded-l-lg py-3 px-4 focus:outline-hidden focus:ring-purple-600 focus:border-transparent" autoComplete="off" required  />
    ...
    <div className="text-center">© 2026 Your Companys - All rights reserved.</div>
    {/* <!----> */}
</div>
  );
}